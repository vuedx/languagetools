...
export function createTypescriptLanguageService(
  ...
  return {
    ...
    service: {
      ...
      // getSemanticClassifications: (...args) => service.applyCodeActionCommand(...args),
      ...
      // getSyntacticClassifications: (fileName: string, span: Typescript.TextSpan, format: Typescript.SemanticClassificationFormat) => service.applyCodeActionCommand(...args),
