...
export type ComponentSetupFnAnalyzer = AbstractAnalyzerFn<
  FunctionExpression | ArrowFunctionExpression | ObjectMethod | FunctionDeclaration
>;
...
export interface Plugin {
  ...
  options?: ComponentOptionsAnalyzer[] | Record<string, AbstractAnalyzerFn<ObjectMember>>;
